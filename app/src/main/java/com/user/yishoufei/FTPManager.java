...
/**
 * Created by issuser on 2017/12/16.
 */
...
public class FTPManager {
    ...
    public boolean createDirectory(String path) throws Exception {
        ...
        System.out.println(directory+"创建目录路径\n");
        int start = 0;
        int end = 0;
    ...
    public synchronized boolean uploadFile( String localPath, String serverPath)
        ...
        //System.out.println("获取安卓路径=="+file);
        System.out.println("本地路径为"+localPath);
        System.out.println(localFile);//获取标准的路径
        System.out.println(localFile.getAbsolutePath());//获取绝对路径
        ...
        System.out.println("文件长度=="+localSize);
...
//            }
//        }
        ftpClient.deleteFile(fileName);//每次全量上传，先删除服务器文件
